...
<body bgcolor="CCCFFF">
	...
	<div align="center">
		<table border="0" cellspacing="0" cellpadding="0" width="100%"
			...
			<tr>
				<td width="33%"><a
					href="http://localhost:8080/PIMS/lookMessage/lookMessage.jsp">查看个人信息</a>
				</td>
				<td width="33%"><a
					href="http://localhost:8080/PIMS/lookMessage/updateMessage.jsp">修改个人信息</a>
				</td>
				<td width="33%">修改密码</td>
			</tr>
		</table>
	...
	<br>
	<br>
	<form action="http://localhost:8080/PIMS/UpdatePasswordServlet"
		method="post">

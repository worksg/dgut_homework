	...
	<table align="center">
		<tr>
			<td colspan="3" align="center">
				<h3>
					<font color="red">请填写以下注册信息</font>
				</h3>
			</td>
		</tr>
		<tr>
			<td>
				<form action="http://localhost:8080/PIMS/RegisterServlet"
					method="post">
					<table border="2" cellspacing="0" cellpadding="0" bgcolor="AAABBB">
						...
						<tr>
							...
							</select>年 <select name="mouth" size="1">
						...
						<tr>
							...
							<td><input type="radio" name="nation" value="汉族" checked>汉族
								...
								type="radio" name="nation" value="其它">其它</td>
						</tr>
						<tr>
							<td>用户学历</td>

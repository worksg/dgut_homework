    ...
    <body bgcolor="CCCFFF">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
          <tr>
              ...
              <td width="20%">
                  <a href="http://localhost:8080/PIMS/dateManager/lookDate.jsp">查看日程</a>
              </td>
              <td width="20%">
                  <a href="http://localhost:8080/PIMS/dateManager/updateDate.jsp">修改日程</a>
              </td>
              <td width="20%">
                  <a href="http://localhost:8080/PIMS/dateManager/deleteDate.jsp">删除日程</a>
              </td>
          </tr>
      </table>
      </div>
